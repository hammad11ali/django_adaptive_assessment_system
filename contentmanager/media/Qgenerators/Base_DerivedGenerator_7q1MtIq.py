...
class Base_DeriveGenerator(QGenerator.QBase):
    def __init__(self):
        super().__init__()
        self.baseUnit = [("Meter", "Length"), ("Kilogram", "Mass"), ("Second", "Time"), ("Amphere", "Current"),
                         ("Kelvin", "Temperature"), ("Candela", "Intensity of Light"), ("Mole", "Amount of Substance")]
        self.deriveUnit = [("Newton", "Force"), ("Joule", "Work"), ("Watt", "Power"), ("Volt", "Potential difference"), (
            "Hertz", "Frequency"), ("Radian", "Angle"), ("Pascal", "Pressure"), ("Coulumb", "Electric charge"), ("Ohm", "Resistance")]
    ...
    def whichOne(self, correct, incorrect, relation):
        ...
        detail=""+correct+" is a "+relation+" . It is basic Information related to Physical unit."
